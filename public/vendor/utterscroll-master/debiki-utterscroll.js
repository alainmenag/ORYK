...
debiki.Utterscroll = (function(options) {
  ...
  function startScroll(event) {
    ...
    $(document.body).css('cursor', 'grabbing');  // 'move' cursor
  ...
  var api = {
    enable: function(options) {
	 ...
	 //$('html').css('cursor', 'grab');  // 'move' cursor
...
if (window.debiki && !('ontouchstart' in window || navigator.maxTouchPoints)) debiki.Utterscroll.enable({
	scrollstoppers: '.no-scroll, .noscroll, .MuiSlider-root, .MuiDialog-root, .picker-item',
});